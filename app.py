...
with tab1:
    ...
    with col3:
        ...
        st.session_state.tolanguage = st.selectbox('To Language', ('','Afrikaans', 'Albanian','Amharic','Arabic','Armenian','Assamese','Azerbaijani (Latin)','Bangla','Bashkir','Basque','Bosnian (Latin)','Bulgarian','Cantonese (Traditional)','Catalan','Chinese (Literary)','Chinese Simplified','Chinese Traditional','Croatian','Czech','Danish','Dari', 'Divehi','Dutch','English','Estonian','Faroese','Fijian','Filipino','Finnish','French','French (Canada)','Galician','Georgian','German','Greek','Gujarati','Haitian Creole','Hebrew','Hindi','Hmong Daw (Latin)','Hungarian','Icelandic','Indonesian','Interlingua','Inuinnaqtun','Inuktitut','Inuktitut (Latin)','Irish','Italian','Japanese','Kannada','Kazakh (Cyrillic)','Kazakh (Latin)','Khmer','Klingon','Klingon (plqaD)','Korean','Kurdish (Arabic) (Central)','Kurdish (Latin) (Northern)','Kyrgyz (Cyrillic)','Lao','Latvian','Lithuanian','Macedonian','Malagasy','Malay (Latin)','Malayalam','Maltese','Maori','Marathi','Mongolian (Cyrillic)','Mongolian (Traditional)','Myanmar (Burmese)','Nepali','Norwegian','Odia','Pashto','Persian','Polish','Portuguese (Brazil)','Portuguese (Portugal)','Punjabi','Queretaro Otomi','Romanian','Russian','Samoan (Latin)','Serbian (Cyrillic)','Serbian (Latin)','Slovak','Slovenian','Somali','Spanish','Swahili (Latin)','Swedish','Tahitian','Tamil','Tatar (Latin)','Telugu','Thai','Tibetan','Tigrinya','Tongan','Turkish','Turkmen (Latin)','Ukrainian','Upper Sorbian','Urdu','Uyghur (Arabic)','Uzbek (Latin)','Vietnamese','Welsh','Yucatec Maya','Zulu'))
...
with tab2:
    ...
    with dcol2:
        ...
        st.session_state.dtolanguage = st.selectbox('To Language', ('','Afrikaans', 'Albanian','Amharic','Arabic','Armenian','Assamese','Azerbaijani (Latin)','Bangla','Bashkir','Basque','Bosnian (Latin)','Bulgarian','Cantonese (Traditional)','Catalan','Chinese (Literary)','Chinese Simplified','Chinese Traditional','Croatian','Czech','Danish','Dari', 'Divehi','Dutch','English','Estonian','Faroese','Fijian','Filipino','Finnish','French','French (Canada)','Galician','Georgian','German','Greek','Gujarati','Haitian Creole','Hebrew','Hindi','Hmong Daw (Latin)','Hungarian','Icelandic','Indonesian','Interlingua','Inuinnaqtun','Inuktitut','Inuktitut (Latin)','Irish','Italian','Japanese','Kannada','Kazakh (Cyrillic)','Kazakh (Latin)','Khmer','Klingon','Klingon (plqaD)','Korean','Kurdish (Arabic) (Central)','Kurdish (Latin) (Northern)','Kyrgyz (Cyrillic)','Lao','Latvian','Lithuanian','Macedonian','Malagasy','Malay (Latin)','Malayalam','Maltese','Maori','Marathi','Mongolian (Cyrillic)','Mongolian (Traditional)','Myanmar (Burmese)','Nepali','Norwegian','Odia','Pashto','Persian','Polish','Portuguese (Brazil)','Portuguese (Portugal)','Punjabi','Queretaro Otomi','Romanian','Russian','Samoan (Latin)','Serbian (Cyrillic)','Serbian (Latin)','Slovak','Slovenian','Somali','Spanish','Swahili (Latin)','Swedish','Tahitian','Tamil','Tatar (Latin)','Telugu','Thai','Tibetan','Tigrinya','Tongan','Turkish','Turkmen (Latin)','Ukrainian','Upper Sorbian','Urdu','Uyghur (Arabic)','Uzbek (Latin)','Vietnamese','Welsh','Yucatec Maya','Zulu'))
